...
```
cd existing_repo
git remote add origin https://gitlab.com/apexbugfinder/sovereignblack-console.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/apexbugfinder/sovereignblack-console/-/settings/integrations)
